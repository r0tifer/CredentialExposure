@{ 
    ...
    # Email User Password: (Required when NotifyUser or NotifyManager is $true) Encrypted string generated by Get-PwndNotifcationPassworSecret for the notification email account.
    EmailUserPassword = ""
