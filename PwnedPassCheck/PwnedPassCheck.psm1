...
@{
    ...
    # EmailUserPassword: (Required when NotifyUser or NotifyManager is $true) Encrypted string generated by Get-ExposureNotificationSecret for the notification email account.
    EmailUserPassword = ""
