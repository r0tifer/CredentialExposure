...
@{
    ...
    # EmailUserPassword: (Required when NotifyUser or NotifyManager is $true) Encrypted string generated by New-PwnedNotificationPasswordSecret for the notification email account.
    EmailUserPassword = ""
